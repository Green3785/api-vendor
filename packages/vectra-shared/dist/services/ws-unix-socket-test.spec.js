...
const describeUnixSocket = process.env.RUN_WS_UNIX_SOCKET_TESTS === 'true' ? describe : describe.skip;
describeUnixSocket('WebSocket Unix Socket - Actual Connection Test', () => {
...
//# sourceMappingURL=ws-unix-socket-test.spec.js.map