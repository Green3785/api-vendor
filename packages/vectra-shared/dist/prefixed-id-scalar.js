...
\`\`\`
    ...
    serialize(value) {
        ...
        const serverId = globalThis.getServerIdentifier();
    ...
    parseLiteral(ast) {
        if (ast.kind !== Kind.STRING) {
            ...
            throw new Error(`PrefixedID cannot represent non-string literal value: ${'value' in ast ? ast.value : null}`);
        }
...
export { PrefixedID };
//# sourceMappingURL=prefixed-id-scalar.js.map