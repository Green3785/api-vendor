import { DomainGetXMLDescFlags, ConnectListAllDomainsFlags } from './types.js';
...
export class Hypervisor {
     ...
     */
    async connectListAllDomains(flags = ConnectListAllDomainsFlags.ACTIVE | ConnectListAllDomainsFlags.INACTIVE) {
        const nativeDomains = await wrapMethod(this.nativeHypervisor.connectListAllDomains.bind(this.nativeHypervisor), flags);
        return nativeDomains.map((d) => new Domain(d, this));
    }
    /**
     ...
     */
    async connectListDefinedDomains() {
     ...
     */
    async domainCreateXML(xml) {
        const nativeDomain = await wrapMethod(this.nativeHypervisor.domainCreateXML.bind(this.nativeHypervisor), xml);
     ...
     */
    async domainDefineXML(xml) {
        const nativeDomain = await wrapMethod(this.nativeHypervisor.domainDefineXML.bind(this.nativeHypervisor), xml);
        return new Domain(nativeDomain, this);
    }
    /**
     ...
     */
    async domainLookupByID(id) {
        const nativeDomain = await wrapMethod(this.nativeHypervisor.domainLookupByID.bind(this.nativeHypervisor), id);
        return new Domain(nativeDomain, this);
    }
    /**
     ...
     * @throws {LibvirtError} If the domain is not found or lookup fails
     */
    async domainLookupByName(name) {
        const nativeDomain = await wrapMethod(this.nativeHypervisor.domainLookupByName.bind(this.nativeHypervisor), name);
        return new Domain(nativeDomain, this);
    }
    /**
     ...
     * @throws {LibvirtError} If the domain is not found or lookup fails
     */
    async domainLookupByUUIDString(uuid) {
        const nativeDomain = await wrapMethod(this.nativeHypervisor.domainLookupByUUIDString.bind(this.nativeHypervisor), uuid);
        return new Domain(nativeDomain, this);
    }
    /**
     ...
     */
    async domainSave(domain, filename) {
        return wrapMethod(this.nativeHypervisor.domainSave.bind(this.nativeHypervisor), domain.getNativeDomain(), filename);
    }
    /**
     ...
     */
    async domainCreate(domain) {
        return wrapMethod(this.nativeHypervisor.domainCreate.bind(this.nativeHypervisor), domain.getNativeDomain());
    }
    /**
     ...
     */
    async domainShutdown(domain) {
        return wrapMethod(this.nativeHypervisor.domainShutdown.bind(this.nativeHypervisor), domain.getNativeDomain());
    }
    /**
     * Pauses a domain.
     ...
     */
    async domainSuspend(domain) {
        return wrapMethod(this.nativeHypervisor.domainSuspend.bind(this.nativeHypervisor), domain.getNativeDomain());
    }
    /**
     ...
     */
    async domainResume(domain) {
        return wrapMethod(this.nativeHypervisor.domainResume.bind(this.nativeHypervisor), domain.getNativeDomain());
    }
    /**
     ...
     */
    async domainDestroy(domain) {
        return wrapMethod(this.nativeHypervisor.domainDestroy.bind(this.nativeHypervisor), domain.getNativeDomain());
    }
    /**
     ...
     */
    async domainUndefine(domain) {
        return wrapMethod(this.nativeHypervisor.domainUndefine.bind(this.nativeHypervisor), domain.getNativeDomain());
    }
    /**
     ...
     */
    async domainGetInfo(domain) {
        return wrapMethod(this.nativeHypervisor.domainGetInfo.bind(this.nativeHypervisor), domain.getNativeDomain());
    }
    /**
     ...
     */
    async domainGetID(domain) {
        return wrapMethod(this.nativeHypervisor.domainGetID.bind(this.nativeHypervisor), domain.getNativeDomain());
    }
    /**
     ...
     */
    async domainGetName(domain) {
        return wrapMethod(this.nativeHypervisor.domainGetName.bind(this.nativeHypervisor), domain.getNativeDomain());
    }
    /**
     ...
     */
    async domainGetUUIDString(domain) {
        return wrapMethod(this.nativeHypervisor.domainGetUUIDString.bind(this.nativeHypervisor), domain.getNativeDomain());
    }
    /**
     ...
     */
    async domainGetXMLDesc(domain, flags = DomainGetXMLDescFlags.NONE) {
        return wrapMethod(this.nativeHypervisor.domainGetXMLDesc.bind(this.nativeHypervisor), domain.getNativeDomain(), flags);
    }
    /**
     ...
     */
    async connectGetMaxVcpus(type = 'qemu') {
        return wrapMethod(this.nativeHypervisor.connectGetMaxVcpus.bind(this.nativeHypervisor), type);
    }
    /**
     ...
     */
    async domainRestore(filename) {
        return wrapMethod(this.nativeHypervisor.domainRestore.bind(this.nativeHypervisor), filename);
    }
}
